...
pg = st.navigation({
    ...
    "Metrics": [
        ...
        st.Page(page3, title="App statuses over time", icon=":material/access_time:"),
        st.Page(page3, title="Cloud apps leaderboard", icon=":material/share:"),
        # st.Page(page3, title="App statuses over time2", icon=":material/access_time:"),
        # st.Page(page3, title="Cloud apps leaderboard2", icon=":material/share:"),
        # st.Page(page3, title="App statuses over time3", icon=":material/access_time:"),
        # st.Page(page3, title="Cloud apps leaderboard3", icon=":material/share:"),
        # st.Page(page3, title="App statuses over time4", icon=":material/access_time:"),
        # st.Page(page3, title="Cloud apps leaderboard4", icon=":material/share:"),
        # st.Page(page3, title="App statuses over time5", icon=":material/access_time:"),
        # st.Page(page3, title="Cloud apps leaderboard5", icon=":material/share:"),
        ]
})
